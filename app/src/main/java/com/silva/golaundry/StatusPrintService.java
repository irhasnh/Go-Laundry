...
public class StatusPrintService extends AsyncTask<String, Void, String> {
    private Context context;

    Get get = new Get();

    public StatusPrintService(Context context){
    ...
    protected String doInBackground (String... arg0){
        ...
        try{
            ...
            data += "&operator=" + URLEncoder.encode(user, "UTF-8");


            link = get.getUrl() + "proses_pesanan.php" + data;
            Log.d("linkk",link);
